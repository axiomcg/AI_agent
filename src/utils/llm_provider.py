...
def get_llm_model(provider: str, **kwargs):
    ...
    if provider == "anthropic":
        ...
        default_headers = {}
        http_referer = kwargs.get("http_referer") or os.getenv("LLM_HTTP_REFERER")
        x_title = kwargs.get("title") or os.getenv("LLM_TITLE")
        if http_referer:
        ...
        return ChatOpenAI(
            model=kwargs.get("model_name", "google/gemini-2.5-flash-lite"),
            temperature=kwargs.get("temperature", 0.0),
            base_url=base_url,
            api_key=api_key,
